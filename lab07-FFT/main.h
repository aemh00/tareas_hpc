...
void fft_recursive(TYPE* x, TYPE* X_real, TYPE* X_imag, int N, int nt);
...
void fft_recursive(TYPE* x, TYPE* X_real, TYPE* X_imag, int N, int nt) {
	if(N==16){
        ...
        fft_recursive(x_even, X_real_even, X_imag_even, N/2, nt);
        fft_recursive(x_odd, X_real_odd, X_imag_odd, N/2, nt);
        #pragma omp parallel shared(x_even, x_odd, X_real_even,X_imag_even, X_real_odd, X_imag_odd)
        {
